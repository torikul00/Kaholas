...
function App() {
  return (
    <main className='h-screen w-full p-4'>
      <h1 className='text-4xl leading-snug font-extrabold'>Summer Art Camp! 5 Days of Artists and Painting Monet, Van Gogh, Matisse, & More</h1>
      ...
      <div className="content-container flex">
        ...
        <div className="images w-2/4 p-4">
          sfsdf
        </div>
      </div>
